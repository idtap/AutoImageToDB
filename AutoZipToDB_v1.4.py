...
#////////////////////////////////////////////////////
# 圖名重複及自動更名
def checkMapName(check_path, check_name) :
    return False
       ...
       try:
           ...
           if zip_name in histlines:
               ...
               if nowImage_args['bits'] == '16' :
                   ...
                   print( '\n轉入8bit Mosaic Dataset:'+nowImage_args['gdbName']+'/'+nowImage_args['datasetName_8'] )
                   ...
                   print( '\n轉完，將 zip 檔移動到各星種:'+nowImage_args['fileStore_16']+'/'+zip_name )
               ...
               # 否則處理 8 bit
                   ...
                   print( '\n轉完，將 zip 檔移動到各星種:'+nowImage_args['fileStore_8']+'/'+zip_name )
