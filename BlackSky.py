        ...
        return [
                {
                    ...
                    'description': ("Supports reading of BlackSky metadata files"),
...
# ----- ## ----- ## ----- ## ----- ## ----- ## ----- ## ----- ## ----- ##
# BlackSky builder class
# ----- ## ----- ## ----- ## ----- ## ----- ## ----- ## ----- ## ----- ##


class BlackSkyBuilder():

    def __init__(self, **kwargs):
        self.SensorName = 'BlackSky'
        self.utilities = Utilities()

    def canOpen(self, datasetPath):
        # Open the datasetPath and check if the metadata file contains the string BlackSky
        return self.utilities.isBlackSky1(datasetPath)
